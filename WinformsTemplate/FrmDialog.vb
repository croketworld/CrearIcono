Public NotInheritable Class FrmDialog
    ...
    Private Sub FrmDialog_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        End If
        Me.Text = String.Format(System.Globalization.CultureInfo.InvariantCulture, "Acerca de {0}", ApplicationTitle)
        ...
        Me.LabelVersion.Text = String.Format(System.Globalization.CultureInfo.InvariantCulture,
                                             "Versión {0}", My.Application.Info.Version.ToString)
